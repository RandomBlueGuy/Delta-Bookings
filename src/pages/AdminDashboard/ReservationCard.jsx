      ...
      >
        <div className="HotelMicroCard">
          <figure className="HotelMicroCard__HotelImg">
            <img
              src={`https://raw.githubusercontent.com/RandomBlueGuy/PROYECTO-FINAL-MIR/main/src/DataBase/Hotel/Rooms/room${
        ...
        <div className="CheckTable">
          <table>
            ...
            <tbody>
              <tr>
                <td style={{textAlign: "center"}}>{booking.CheckInDate}</td>
                <td style={{textAlign: "center"}}>{booking.CheckOutDate}</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td className="PaymentDetails__col2">
                  {booking.payments.CardFirstName}
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td className="PaymentDetails__col2">
                  {booking.payments.CardSecondName}
                </td>
              </tr>
              <tr>
                <td>
